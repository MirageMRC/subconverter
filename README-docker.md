...
This is a minimized image to run https://github.com/miragemrc/subconverter.

For running this docker, simply use the following commands:
```bash
# run the container detached, forward internal port 25500 to host port 25500
docker run -d --restart=always -p 25500:25500 miragemrc/subconverter:latest
...
services:
  subconverter:
    image: miragemrc/subconverter:latest
...
FROM miragemrc/subconverter:latest
